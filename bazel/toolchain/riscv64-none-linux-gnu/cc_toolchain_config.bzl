...
def _impl(ctx):
                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-nostdinc",
                            "-I/usr/riscv64-linux-gnu/sys-root/usr/include",
                            "-I/usr/lib/gcc/riscv64-linux-gnu/12/include",
                            "-I/usr/lib/gcc/riscv64-linux-gnu/12/include-fixed",
                        ],
                    ),
                ],
            ),
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        cxx_builtin_include_directories = [
            "/usr/riscv64-linux-gnu/sys-root/usr/include",
            "/usr/lib/gcc/riscv64-linux-gnu/12/include",
            "/usr/lib/gcc/riscv64-linux-gnu/12/include-fixed",
        ],
        features = features,
